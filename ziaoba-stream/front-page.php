        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-meta">
                    ...
                    <span><?php echo esc_html( ziaoba_get_content_meta( $hero->ID, 'duration' ) ); ?></span>
                    <span style="border: 1px solid #666; padding: 0 6px; border-radius: 2px;"><?php echo esc_html( ziaoba_get_content_meta( $hero->ID, 'age_rating' ) ); ?></span>
                </div>
...
<main class="container">
    ...
    <?php if ( is_user_logged_in() ) : ?>
        <?php echo do_shortcode( '[ziaoba_continue_watching]' ); ?>
    <?php endif; ?>
                ...
                ?>
                    <div class="swiper-slide poster-card" onclick="location.href='<?php the_permalink(); ?>'">
                        <div class="card-img-wrapper">
                            <?php echo wp_kses_post( ziaoba_get_display_poster( get_the_ID(), 'medium_large' ) ); ?>
                        ...
                        <div class="card-info">
                            ...
                            <div class="card-meta">
                                ...
                                <span><?php echo esc_html( ziaoba_get_content_meta( get_the_ID(), 'age_rating' ) ); ?></span>
                            </div>
                        </div>
                    </div>
